...
<%@page import="common.BoardRangeDTO"%>
    ...
    <main class="main">
        ...
        <div class="filter-area">
            ...
            <div class="tabs">
                ...
                <a href="${pageContext.request.contextPath}/inquiry?status=all"
                ...
                <a href="${pageContext.request.contextPath}/inquiry?status=waiting"
                ...
                <a href="${pageContext.request.contextPath}/inquiry?status=complete"
        ...
        <div class="table-wrap">
            ...
            <table class="inquiry-table">
                ...
                <%
                	...
                	int rowNum =
                		    ((range.getPage() - 1) * range.getPageScale()) + 1;
                ...
                %>
                    ...
                    <tr class="<%= waiting ? "waiting-row" : "" %>"
                        onclick="moveDetail(<%= dto.getInquiryCode() %>)">
            ...
            %>
                ...
                <button type="button"
                        ...
                        onclick="location.href='${pageContext.request.contextPath}/inquiry?page=<%= i %>&status=<%= status %>'">
...
function moveDetail(inquiryCode){

    location.href =
        "${pageContext.request.contextPath}/inquiry/detail?inquiryCode="
        + inquiryCode;
}
