        ...
        <form class="inquiry-form" id="inquiryForm" method="post"
            ...
            <div class="inquiry-field">
                ...
                <textarea class="inquiry-textarea" id="inquiryContent" name="inquiryContent"
                          maxlength="2000"><%=formContent%></textarea>
                <div class="inquiry-field-meta"><span>최대 2,000자</span><span id="contentCount">0/2000</span></div>
            </div>
            <div class="inquiry-error" id="clientError" hidden></div>
            <div class="inquiry-actions">
                <a class="inquiry-button inquiry-button-light" href="<%=request.getContextPath()%>/user-inquiry/list">취소</a>
